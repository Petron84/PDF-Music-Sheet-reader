...
from legacycode.actionmodelbuilder import ActionModel, inference_transforms
...
class LineProcessor():
    ...
    def _randomSeparator(self, line, x_increment,iteration,linedifferentiator):
        ...
        while x_end < w:
            ...
            count += 1
            cv.imwrite(f'media\\actionmodeldataset_v3\\{self._linecountsubstring}_random{linedifferentiator}_{clefofline}_{self._namesubstring}_v{iteration}_{count}.png', segment)
            x_start = x_end
            x_end = x_start + x_increment
